...
int main()
{
	...
	cond.distance_collimator_to_detector = 9.4;
	cond.collimator_h = 1.;
	...
	cond.aperture_degree_zx = 25.;
	std::vector<float> pinhole_theta_xy{ -24., -13., 0., 13., 24., -24., -13., 0., 13., 24. };
	// std::vector<float> pinhole_theta_xy(11, 0.);
	std::vector<float> pinhole_theta_zx{ -9.5f, -9.5f, -9.5f,  -9.5f, -9.5f, 9.5f, 9.5f, 9.5f, 9.5f, 9.5f };
