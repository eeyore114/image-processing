...
void gaussian(float *, int, int, double, double, double, double);
...
main(int argc, char *argv[] )
{
	...
	printf(" *** Make Gaussian Image ***\n");
	gaussian(pm->img, pm->nx, pm->ny, pm->a, pm->w, pm->x0, pm->y0);
...
void gaussian(float *img, int nx, int ny, double a, double w, double x0, double y0)
{
	int    i, j;
	double x, y;
