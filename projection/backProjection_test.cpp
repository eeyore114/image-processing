...
const char readFileName[] = "float_testCircleProjection_128-360.raw";
const char writeFileName[] = "test_for_cuda_float_128-128.raw";
...
int main()
{
	...
	readRawFile(readFileName, H * 360, g);
