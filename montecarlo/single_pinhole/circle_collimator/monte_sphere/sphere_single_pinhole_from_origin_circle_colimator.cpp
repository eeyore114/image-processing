...
int main()
{
	...
	{
		Sphere = "mu-map_air_float_128-128-128.raw";
	...
	for(int i = 0; i < 6; i++)
	{
		...
		if(medium_num == 2) { sprintf(writeFileName, "result_h2o/from_origin/sphere_h2o_single_pinhole_from_origin_%02d_double_180-180.raw", i); }
		else if (medium_num == 3) { sprintf(writeFileName, "result_multi/from_origin/sphere_multi_single_pinhole_from_origin_%02d_double_180-180.raw", i); }
		else if (medium_num == 4)  { sprintf(writeFileName, "result_air/from_origin/sphere_air_single_pinhole_from_origin_%02d_double_180-180.raw", i); }
	...
	if(medium_num == 2) { writeFileName = "result_h2o/from_origin/sphere_h2o_single_pinhole_from_origin_sum_double_180-180.raw"; }
	else if (medium_num == 3) { writeFileName = "result_multi/from_origin/sphere_multi_single_pinhole_from_origin_sum_double_180-180.raw"; }
	else  { writeFileName = "result_air/from_origin/sphere_air_single_pinhole_from_origin_sum_double_180-180.raw"; }
