...
int main()
{
	...
	for(int i = 0; i < 6; i++)
	{
		...
		if(medium_num == 1) 	 { sprintf(writeFileName, "cylinder_ca_single_pinhole_from_origin2_%02d_double_180-180.raw", i); }
		else if(medium_num == 2) { sprintf(writeFileName, "cylinder_h2o_single_pinhole_from_origin2_%02d_double_180-180.raw", i); }
		else 					 { sprintf(writeFileName, "cylinder_multi_single_pinhole_from_origin2_%02d_double_180-180.raw", i); }
	...
	if(medium_num == 1)
	{
		write_energy_spectrum_name = "energy_ca_cylinder_single_pinhole_from_origin2.csv";
		write_image_profile_name = "position_ca_cylinder_single_pinhole_from_origin2.csv";
	}
	else if(medium_num == 2)
	{
		write_energy_spectrum_name = "energy_h2o_cylinder_single_pinhole_from_origin2.csv";
		write_image_profile_name = "position_h2o_cylinder_single_pinhole_from_origin2.csv";
	}
	else
	{
		write_energy_spectrum_name = "energy_multi_cylinder_single_pinhole_from_origin2.csv";
		write_image_profile_name = "position_multi_cylinder_single_pinhole_from_origin2.csv";
	}
